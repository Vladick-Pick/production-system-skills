...
function composeSchema() {
  ...
  Object.assign(schema.enums, structuredClone(overlay.enum_overrides ?? {}));
...
function buildPanel(sheet) {
  ...
  const sections = [
    ...
    { row: 17, col: 0, width: 7, title: "Внешняя цепочка", headers: ["контрагент", "направление", "компонент", "контракт", "интерфейс", "документ", "действие"], values: ["Поставщик лидов", "поставляет", "Лид качества A (продукт)", "Поставка лидов", "API CRM", "Открыть документ", "Принять лид"] },
