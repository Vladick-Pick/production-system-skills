...
def main() -> int:
    ...
    basename = f"{process['process_id']}--{process['version_id']}"
    bpmn_path = args.output_dir / f"{basename}.bpmn"
    svg_path = args.output_dir / f"{basename}.svg"
    manifest_path = args.output_dir / f"{basename}.manifest.json"
