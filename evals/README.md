...
К release-blocking набору добавлены сценарии границы карты и территории, проектирования показателя от управленческого вопроса, финансового показателя, трёх независимых осей расхода, позиции против условий назначения и миграции v0.3→v0.4. Эти сценарии должны пройти отдельные fresh-agent trials; доказательство v0.3 ниже не переносится на новый кандидат автоматически.
